...
Write-host "`tPART 2.2 - AD Konfiguration"
    ...
    {
    ##Lav vÊrdierne i .csv filen til variabler
    ...
    Write-host "`t`t`tSECURITY GROUP: Tilf√∏jer alle fra $afdeling til $SecGroupName.." -f Yellow
    ...
    #Lav shares i den oprettede mappe, SÊt NTFS + Share rettigheder
